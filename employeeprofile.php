    ...
    <div class="my-work">
      ...
      <div id="orders-table">
        ...
        <?php foreach($processOrders as $order):?>
          ...
          <td><button type="button" id="<?php echo $order['orderID'];?>"class="btn btn-outline-success view_data" data-toggle="modal" data-target="#exampleModalCenter">View</button></td>
          </tr>
      <?php endforeach?>
    </table>
      <?php endif; ?>
      ...
      <?php if(count($processOrders) === 0):?>
        <div class="links"><a>All orders were approved.</a></div>
      <?php endif; ?>
    </div>
